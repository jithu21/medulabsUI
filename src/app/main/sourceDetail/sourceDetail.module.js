(function ()
{
    ...
    {
        $stateProvider.state('app.sourceDetail', {
            url      : '/rhea/source/:objectId',
            views    : {
                'content@app': {
                    templateUrl: 'app/main/sourceDetail/sourceDetail.html',
                    controller : 'sourceDetailController as vm'
                }
            },
            bodyClass: 'icons',
            resolve  : {
